...
const IDCard = ({ name, linkedin }: { name: string; linkedin: string; }) => {
    return (
        <div className="mx-auto">
            {/* STRAP */}
            <div className="w-[40px] h-[80px] bg-[#2b28ff] mx-auto" />
            ...
            {/* CARD */}
            <div className="w-[400px] bg-[#f6f6f6] border border-[#e9e9e9] mx-auto -my-[15px] px-1.5 relative z-0 rounded-[28px]">
                ...
                <div className="bg-white min-h-[400px] rounded-[28px] px-[32px]">
                    ...
                    <div className="flex justify-between items-center py-5">
                        <p className="font-mono font-bold text-xl leading-[1.1]">BiOS<br />Community</p>
                        <Image src={biosLogo} alt="BiOS Community Logo" className="w-[72px]" />
                    </div>
                    {/* LOGO */}

                    {/* TITLE */}
                    <div className="py-7 space-y-2">
                        <p className="font-semibold text-gray-600 text-lg">I'm attending</p>
                        <h1 className="font-bold text-[50px] leading-[1.2]">Open Source Connect</h1>
                    </div>
                    {/* TITLE */}
                ...
                {/* WEBSITE LINK */}
                <p className="py-2 text-sm text-gray-500 flex gap-1 items-center w-fit mx-auto">Create your own at <span className="text-black">bios.vercel.app/badge</span><ArrowUpRight className="text-[#2b28ff]" size={18} /></p>
